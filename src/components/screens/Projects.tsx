...
function Projects() {
  ...
  const experience = [
    {
      image: "/Trabajos/GradienteLogo.png",
      title: "Gradiente",
      linkDeploy: "https://gradiente.ai",
      description:
        "Tuve la oportunidad de trabajar con gradiente, una startup colombiana que ofrece soluciones legislativas a los interesados, en donde desarrolle el cliente de la aplicación. ",
    },
    {
      image: "/Trabajos/JacidiLogo.png",
      title: "Jacidi",
      linkDeploy: "https://www.jacidi.com",
      description:
        "Trabaje con Jacidi, una empresa establecida venezolana de desarrollo que ofrece soluciones de software a empresas del area turistica desarrollando algunas funcionalidades en el framework angular.",
    },
    {
      image: "/Trabajos/FonaxLogo.png",
      title: "Fonax",
      linkDeploy: "http://www.fonax.com/web/",
      description:
        "Trabaje con Fonax, una empresa venezolana establecida en donde cumplí labores como fullstack web developer, llevando labores del lado del servidor y del cliente",
    },
    {
      image: "/Trabajos/EE.png",
      title: "Español con E",
      description:
        "Español con E es una startup que ofrece capacitacion en idioma Español a los interesados, tuve el gusto de trabajar como desarrollador frontend y de guiar a desarrolladores trainee a hacer el mejor trabajo posible, fue una experiencia que disfrute mucho.",
    },
  ];
  let cards = [
    {
      image: "/Trabajos/excel-microsoft.gif",
      title: "React CSV to JSON",
      linkDeploy: "https://react-test-np5ub7ect-gustavitory.vercel.app",
      linkRepo: "https://github.com/Gustavitory/ReactTestApp",
      description:
    ...
    },
    {
      ...
      linkRepo: "https://github.com/Gustavitory/hp-app",
      description:
        "Harry potter app consume la API publica de harry potter, en esta ocacion utilice musica para dar una experiencia inmersiva en la aplicacion, las tecnologias usadas fueron Javascript, Reactjs, Redux y CSS",
    },
    {
